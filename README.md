## Welcome to CMSC388B Winter 2022
...
Navigate to the directory where you want to clone your repository and run the following command: `git clone https://gitlab.cs.umd.edu/cmsc388Bwinter2022/cmsc388B-<your-directory-id>.git`. When this command is complete you will now see a new directory that will have the name `cmsc388B-<your-directory-id>`.  
2.  Navigate into your new cloned repository. From the command line you would enter: `cd cmsc388B-<your-directory-id>`.  
3.  Run `git remote -v`. You should see an output like the following:  
```
origin	https://gitlab.cs.umd.edu/cmsc388Bwinter2022/cmsc388B-<your-directory-id>.git (fetch)
origin	https://gitlab.cs.umd.edu/cmsc388Bwinter2022/cmsc388B-<your-directory-id>.git (push)
```  
...
`git remote add upstream https://gitlab.cs.umd.edu/arasevic/cmsc388Bwinter2022-student.git`. Once that is complete run `git remote -v` again. You should see the following output:  
```
origin	https://gitlab.cs.umd.edu/cmsc388Bwinter2022/cmsc388B-<your-directory-id>.git (fetch)
origin	https://gitlab.cs.umd.edu/cmsc388Bwinter2022/cmsc388B-<your-directory-id>.git (push)
upstream	https://gitlab.cs.umd.edu/arasevic/cmsc388Bwinter2022-student.git (fetch)
upstream	https://gitlab.cs.umd.edu/arasevic/cmsc388Bwinter2022-student.git (push)
```  
